...
function atualizaAnimacao(){
    ...
    //Colisão com a barra direita e esquerda
    if(tyBola < tyBD + 0.2 && tyBola > tyBD - 0.2 && txBola > 0.8 &&
    txBola_offset > 0)
        txBola_offset = -txBola_offset;
        

    if(tyBola < tyBE + 0.2 && tyBola > tyBE - 0.2 && txBola < -0.8 &&
    txBola_offset < 0)
        txBola_offset = -txBola_offset;
